...
<head>
	...
	<script type="text/javascript" src="/util/Javascript.do/load=jquery,jquery.i18n.properties,utils,gobierno,jspdf.min,jspdf.debug,bootstrap"></script>
		...
		<form id="form" action="javascript:void(null)" method="post" onsubmit="jVideos.buscar()">
			...
			<div id="cabecera">
             ...
             <div id="paso2"><fmt:message key="PASO2" bundle="${etq}" /> </div>     
              <div id="Sucursal"><input type="button" id="Sucursales" name="Sucursales" Onclick="jGobierno.Sucursales()" value ="<fmt:message key="Sucursales" bundle="${etq}" />" /> </div>  
