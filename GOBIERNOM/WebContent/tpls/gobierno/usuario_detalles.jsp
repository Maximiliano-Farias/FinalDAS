...
<tr>
<td><fmt:message key="NOMBRE" bundle="${etq}"/>:</td><td><input type="text" id="Nombre_Usuario" name="Nombre_Usuario" value="${detalles.getNombre()}" readonly="readonly" size="30" /></td>
...
<tr>
<td>D.N.I :</td><td> <input type="text" id="Dni_Usuario" name="Dni_Usuario" value="${detalles.getDni()}"  size="30"/></td>
