...
<tr>
<td>D.N.I :</td><td> <input type="text" id="Dni_Usuario" name="Dni_Usuario" value="${detalles.getDni()}"  size="40"/></td>
<td><fmt:message key="Telefono" bundle="${etq}"/></td><td><input type="text" id="Telefono_Usuario" name="Telefono_Usuario" value="${detalles.getTelefono()}" size="40"/></td>
</tr>
<tr>
<td>MAIL:</td><td><input type="text" id="Mail_Usuario" name="Mail_Usuario" value="${detalles.getMail()}" size="30"/></td>
<td><fmt:message key="DIRECCION" bundle="${etq}"/></td><td><input type="text" id="Direccion_Usuario" name="Direccion_Usuario" value="${detalles.getDireccion()}"  size="40"/></td>
</tr>
<tr >
<td colspan=4><input type="button" id="Actualizar_Datos_Usuario" name="Actualizar_Datos_Usuario" onclick="jGobierno.ActualizarDatosPersonales()" value="ACTUALIZAR" title=<fmt:message key="ACTUALIZAR" bundle="${etq}"/>  /></td>
</tr>
</table>
</div>
