...
<c:choose>
	...
	<table></table>
   <div id="cabecera_buscador"><label><fmt:message key="BUSCADOR_PLANES" bundle="${etq}" /></label><input type="text" name="buscador_plan" id="buscador_plan" size="35" onChange="jGobierno.Buscando()" /><div id="buscando"></div> </div>
